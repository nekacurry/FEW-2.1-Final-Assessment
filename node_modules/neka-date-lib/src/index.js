...
class D {
  ...
  when () {
    ...
    if (calcMonth > 11) {
      return `${calcYear} year(s) from now`
    } else if (calcMonth < -11) {
      return `${Math.abs(calcYear)} year(s) ago`
    } else if (calcMonth > 0) {
      return `${calcMonth} month(s) from now`
    } else if (calcMonth < 0) {
      return `${Math.abs(calcMonth)} month(s) ago`
    } else if (calcHours > 23) {
      return `${Math.abs(calcDay)} day(s) from now`
    } else if (calcHours < -23) {
      return `${Math.abs(calcDay)} day(s) ago`
    } else {
